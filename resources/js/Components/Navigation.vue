            ...
            <ul class="flex items-center flex-shrink-0 space-x-6">
                ...
                <li class="relative">
                    <button class="align-middle rounded-full focus:shadow-outline-blue focus:outline-none"
                        @click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu" v-click-outside="closeNotificationsMenu"
                    ...
                    <template v-if="isNotificationsMenuOpen">
                        <ul @click.away="closeNotificationsMenu"
                ...
                <li class="relative">
                    <button class="align-middle rounded-full focus:shadow-outline-blue focus:outline-none"
                        @click="toggleLanguageMenu" @keydown.escape="closeLanguageMenu" v-click-outside="closeLanguageMenu"
                        aria-label="Language" aria-haspopup="true">
                    ...
                    <template v-if="isLanguageMenuOpen">
                        <ul @click.away="closeLanguageMenu"
                            @keydown.escape="closeLanguageMenu"
                            class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:border-gray-700 dark:text-gray-300 dark:bg-gray-700"
                            aria-label="submenu">
                            <li class="flex" v-if="$page.props.lang !== 'es'">
                                <Link @click="loadLanguageAsync('es')" class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                                    :href="route('lang', 'es')">
                                    <Icon name="es" class="h-5 w-5" /><span class="ml-1">ES</span>
                                </Link>
                            </li>
                            <li class="flex" v-if="$page.props.lang !== 'en'">
                                <Link @click="loadLanguageAsync('en')" class="inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200"
                                    :href="route('lang', 'en')">
                ...
                <li class="relative">
                    <button class="align-middle rounded-full focus:shadow-outline-blue focus:outline-none"
                        @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" v-click-outside="closeProfileMenu"
                        aria-haspopup="true">
