<script setup>
  ...
  import { ref, toRefs, inject, computed, reactive, watch } from 'vue'
        ...
        <template #content>   
          <form class="px-2 bg-white dark:bg-gray-700 rounded" @submit.prevent="createUser">
            ...
            <div class="flex items-center justify-center">
              ...
              <button type="submit" @click="load" :disabled="!formUser.name||!formUser.lastname||!formUser.email||formUser.processing"
