          ...
          <div class="shadow-lg p-4 bg-white dark:bg-gray-700 w-full">
            ...
            <div class="flex items-center justify-between mt-2">
              <div class="relative flex-1">
                ...
                <input
                  class="w-1/3 pl-10 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
