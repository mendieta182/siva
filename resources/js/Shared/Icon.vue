<template>
    <svg v-if="name === 'en'" enable-background="new 0 0 512 512" version="1.1" viewBox="0 0 512 512"
    ...
    <svg v-else-if="name === 'es'" fill="currentColor" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
    ...
    <svg v-else-if="name === 'fr'" class="h-5 w-5" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
        style="enable-background:new 0 0 512 512;" xml:space="preserve">
    ...
    <svg v-else-if="name === 'users'" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.999 511.999" xml:space="preserve">
        <g>
            <g>
    ...
    <svg v-else-if="name==='eye'" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
    ...
    <svg v-else-if="name==='restore'" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72">
        <path
    ...
    <svg v-else-if="name==='plus'" fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
        style="enable-background:new 0 0 512 512;" xml:space="preserve">
        <g>
            <g>
